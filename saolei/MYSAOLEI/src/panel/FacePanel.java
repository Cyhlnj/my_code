...
public class FacePanel extends JPanel{
	...
	private void init() {
		...
		panel.addMouseListener(faceListener);
		
		Icon icon0 = new ImageIcon("./image/d0.gif");
		Icon icon1 = new ImageIcon("./image/d" + MainFrame.allcount / 10
				+ ".gif");
		Icon icon2 = new ImageIcon("./image/d" + MainFrame.allcount % 10
				+ ".gif");
	...
	public void setTime(int count) {
		...
		int s = count /10 %10;
		int b = count /100;
		labelTimeG.setIcon(MainFrame.time[g]);
		labelTimeS.setIcon(MainFrame.time[s]);
		labelTimeB.setIcon(MainFrame.time[b]);
	}
	...
	public void setNumber(int count) {
		...
		labelCountG.setIcon(MainFrame.time[g]);
		labelCountS.setIcon(MainFrame.time[s]);
		labelCountB.setIcon(MainFrame.time[b]);
	}
	
	
	public class FaceListener extends MouseAdapter{
		@Override
		public void mousePressed(MouseEvent e) {
			if (e.getModifiers() == InputEvent.BUTTON1_MASK) {
				labelFace.setIcon(MainFrame.downSmileIcon);
		...
		public void mouseReleased(MouseEvent e) {
			if (e.getModifiers() == InputEvent.BUTTON1_MASK) {
				...
				labelFace.setIcon(MainFrame.smileIcon);
			}
		}
	}
